...
// -------------------------------------------------------------
   public Link4(long d)               // constructor
      { dData = d; }
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
class FirstLastList4
   {
   private Link4 first;               // ref to first item
   private Link4 last;                // ref to last item
// -------------------------------------------------------------
   public FirstLastList4()            // constructor
      {
...
// -------------------------------------------------------------
   public void displayList()
      {
      Link4 current = first;          // start at beginning
